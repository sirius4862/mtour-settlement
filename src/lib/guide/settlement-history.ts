...
export const GUIDE_SETTLEMENT_HISTORY_SELECT =
  'id,tour_id,status,reject_reason,admin_note,guide_confirmed_at,year_month,created_at,submitted_at,updated_at,tour:tours(id,tour_code,pattern,agency_name,start_date,end_date,pax_count)'
