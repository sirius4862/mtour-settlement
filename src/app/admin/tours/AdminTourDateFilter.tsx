...
export function AdminTourDateFilterBar({
  filter,
  view,
  ...
  const quick = adminTourQuickRangeUrls(undefined, view)
  const [from, setFrom] = useState(filter.from ?? '')
  const [to, setTo] = useState(filter.to ?? '')

  const applyCustomRange = () => {
    router.push(buildAdminTourListHref(from || null, to || null, view))
  }
